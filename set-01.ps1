...
$_TenantType		 = "AAD"
$_TenantId			 = "d966aebf-5d1d-4444-bb28-cc4f3f524b75" # The Tenant ID is synonomous with Organization ID is synonomous with Management Group ID
...
$_TenantType		 = "AAD"
$_TenantId			 = "fc4d76ba-f17c-4c50-b9a7-8f3163d27582" # The Tenant ID is synonomous with Organization ID is synonomous with Management Group ID
...
# First Breakfast
Connect-AzAccount -EnvironmentName AzureCloud -TenantId $_TenantId
Connect-AzureAD -AzureEnvironmentName AzureCloud -TenantId $_TenantId
